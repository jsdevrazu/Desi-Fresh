...
const LikeCategoryCard = ({ color, title, path, isBorder }) => {
  return (
    <>
      <div className={`flex items-center justify-center text-center shadow-md rounded-[19px] h-48 ${isBorder ? `border-2 border-primary` : ""}`}>
        <div
          className="h-full p-4 rounded-l-2xl"
